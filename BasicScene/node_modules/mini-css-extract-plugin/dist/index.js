...
var _CssModuleFactory = _interopRequireDefault(require("mini-css-extract-plugin/dist/CssModuleFactory"));

var _CssDependencyTemplate = _interopRequireDefault(require("mini-css-extract-plugin/dist/CssDependencyTemplate"));

var _CssDependency = _interopRequireDefault(require("mini-css-extract-plugin/dist/CssDependency"));

var _pluginOptions = _interopRequireDefault(require("mini-css-extract-plugin/dist/plugin-options"));

var _utils = require("mini-css-extract-plugin/dist/utils");
...
if (_webpack.default.util.serialization && _webpack.default.util.serialization.registerLoader) {
  const pathLength = `${pluginName}/dist`.length;

  _webpack.default.util.serialization.registerLoader(/^mini-css-extract-plugin\//, request => {
    ...
    compiler.hooks.thisCompilation.tap(pluginName, compilation => {
      ...
      if (isWebpack4) {
        ...
        const handler = (chunk, set) => {
          ...
          const CssLoadingRuntimeModule = require('mini-css-extract-plugin/dist/CssLoadingRuntimeModule');

          set.add(_webpack.default.RuntimeGlobals.publicPath);
          compilation.addRuntimeModule(chunk, new _webpack.default.runtime.GetChunkFilenameRuntimeModule(_utils.MODULE_TYPE, 'mini-css', `${_webpack.default.RuntimeGlobals.require}.miniCssF`, referencedChunk => {
