...
export type Schema =
  | (import('json-schema').JSONSchema4 & import('copy-webpack-plugin/node_modules/schema-utils/declarations/validate').Extend)
  | (import('json-schema').JSONSchema6 & import('copy-webpack-plugin/node_modules/schema-utils/declarations/validate').Extend)
  | (import('json-schema').JSONSchema7 & import('copy-webpack-plugin/node_modules/schema-utils/declarations/validate').Extend);
export type ValidationErrorConfiguration = {
  name?: string | undefined;
  baseDataPath?: string | undefined;
  postFormatter?: import('copy-webpack-plugin/node_modules/schema-utils/declarations/validate').PostFormatter | undefined;
};
